...
// import { useNavigate } from 'react-router-dom'; // Commenting out router-related imports as they are not used in a single-file preview
...
// Location and Car data for Uzbekistan
